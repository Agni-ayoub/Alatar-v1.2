...
const Dashboard = ()=>{
    ...
    return(
        <div className="flex shrink-0 flex-wrap sm:h-full w-full">
            <div className="gap-3 sm:gap-2 py-4 px-5 flex flex-wrap w-full">
                <div className="flex gap-3 sm:gap-2 shrink-0 flex-col h-full w-full lg:w-8/12">
                    ...
                    <div className="w-full shadow-[0_2px_8px_var(--text-secondary)] px-4 py-2 border border-[var(--text-secondary)] rounded-md bg-[var(--sideNav-background)]/50 h-full">
                        data 3
                    </div>
                </div>
                <div className="flex-1 shadow-[0_2px_8px_var(--text-secondary)]/50 px-4 py-2 border border-[var(--text-secondary)] bg-[var(--sideNav-background)]/50 rounded-md">
                    data 2
                </div>
            </div>
        </div>
